    ...
    <div class="col">
            ...
            <div class="box box-default">
               ...
               <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="inputEmail4" class="col-sm-3 control-label">Harga IPB (dalam rupiah)</label>
                    ...
                    <div class="form-group">
                        <label for="inputEmail4" class="col-sm-3 control-label">Harga Non IPB (dalam rupiah)</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                        <input type="text" class="form-control" id="inputEmail3" placeholder="Protytping">
                        </div>
                    </div>
                    <div class="form-group">
