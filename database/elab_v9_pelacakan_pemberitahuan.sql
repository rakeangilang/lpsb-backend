...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2019 at 08:36 AM
...
CREATE TABLE `pelacakan` (
  ...
  `KirimSertifikat` tinyint(1) NOT NULL DEFAULT '1',
...
(1, 1, 1, 1, 1, 1, '2019-03-05 04:33:44', NULL, NULL, NULL, NULL, NULL),
(3, 1, 1, 1, 1, 1, '2019-03-05 04:33:50', NULL, NULL, NULL, NULL, NULL),
(4, 1, 1, 1, 1, 1, '2019-03-05 04:33:55', NULL, NULL, NULL, NULL, NULL);
...
(3, 4, 2, NULL, NULL, 1, NULL, 1, 8888, '2019-03-02 09:20:51', 'abcd'),
(4, 4, 3, NULL, NULL, 1, NULL, 1, 8888, '2019-03-03 21:22:10', NULL);
...
--
ALTER TABLE `administrasipesanan`
  MODIFY `IDPesanan` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `sampel`
  MODIFY `IDSampel` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
