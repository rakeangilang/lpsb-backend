...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 02, 2019 at 05:21 PM
...
(3, 'Gilang', 'IPB', 'bogor', '999', 'ganteng@banget.com', '9182938', NULL, NULL, 'h3h3', 'jabar', '231992', 0, NULL, NULL);
...
(3, 1, 0, 0, 0, '2019-03-02 09:20:51', NULL);
...
(1, 'gilang@gmail.com', '$2y$10$DzKfbp59nxqMDRvT1LZI/.iZSSfCxOH8mgRAoKAfV3YrwYyankzQy', '$2y$10$xn48cSPXGdD2OEDxom498OFpiWyE2wpuleslsTW81d0wIqz1.G.ga', 'gilang', 'IPB', 'Depok1', '88', '77', '99', 'gilang', 'bank ipb', '123'),
...
(3, 4, 2, NULL, NULL, 1, NULL, 1, 8888, '2019-03-02 09:20:51', NULL);
...
(3, 2, 1, 'batang', 'Ekstrak', 'Toples', '9', 'Fitokimia', 'Visualisasi warna', 175000);
...
--
ALTER TABLE `administrasipesanan`
  MODIFY `IDPesanan` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `sampel`
  MODIFY `IDSampel` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
