...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 25, 2019 at 04:33 AM
...
CREATE TABLE `keranjang` (
  ...
  `JenisMetodeAnalisis` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `keranjang` (`IDItem`, `IDPelanggan`, `JenisSampel`, `BentukSampel`, `Kemasan`, `Jumlah`, `JenisMetodeAnalisis`, `HargaSampel`, `StatusKeranjang`) VALUES
(1, 4, 'Daun', 'Ekstrak', 'Toples', 5, 'Kapang/Kamir', 110000, 1),
(2, 4, 'batang', 'Ekstrak', 'Toples', 9, 'Kapang/Kamir', 110000, 1),
(3, 4, 'Daun', 'Ekstrak', 'Toples', 4, 'Kapang/Kamir', 110000, 1),
(4, 4, 'Daun', 'Ekstrak', 'Toples', 4, 'Kapang/Kamir', 110000, 1);
...
(2, 'kurt@gmail.com', '$2y$10$NXsCQt3uvicxRocilH1./e9oOeBMJdhRgcmaVOP2eauV9xLiM1BdS', '$2y$10$CyIeiFlBxY3Bn1wgWI5QiOzQL.mXbLQIS6D0T69u9zhaYw34GO94.', 'kurt', 'Nirvana', 'LA', '911', NULL, '66666', 'nirvana intl', 'west bank', '666'),
...
--
ALTER TABLE `keranjang`
  MODIFY `IDItem` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
